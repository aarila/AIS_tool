  ...
  for (i in 1:length(parameters)) 
    local({
      ...
      p = ggplot(DFfinal_month, aes(dummytimedate, DFfinal_month[para]))+
        ...
        stat_summary(fun.y="mean", geom = "line", size = 1, alpha = 0.4, aes(color = "Month average"))+
        ...
        scale_color_manual(values = c("red","gray8", "gray65", "royalblue1", "royalblue4"))
...
mmsi = 	266027000  # Ship MMSI (Maritime Mobile Service Identity)
...
startdate = 20120825 # Date (YYYYMMDD)
starthour = 8       # Hour of day (0-23)
duration =  6      # Duration in hours (1-72)

#Set parameters: "VHM0" = Hs, "VTPK" = Tp, "VPED" = pdr, "VTM01" = Tm01, "VTM10" = Tm10, "TpI" = Tp .
parameters = c("VHM0", "VTPK", "VPED", "VTM01", "VTM10", "TpI")   # c("X", "Y", "Z")   "VHM0", "VTPK", "VPED", "VTM01", "VTM10", "TpI" 

#Set paths to data and output directories
route_file_path = "C:/Users/aarila/Desktop/AIS DATASETIT/AIS/" # AIS data directory.  #Should be .mat files
ncdfpath = "C:/Users/aarila/Desktop/AIS DATASETIT/"    # NetCDF wavemodel data directory  #The data should be stored one month per file with a band for every hour.
output_dir =  "C:/Users/aarila/Desktop/AIS DATASETIT/output"    # Output directory
